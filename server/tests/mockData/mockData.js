...
const mockData = {
  ...
  availableRoles: { message: 'roles retrieved successfully',
    roles:
    [{ id: 1,
      roleName: 'admin',
    ...
    { id: 4,
      ...
      createdAt: '2017-08-17',
      updatedAt: '2017-08-17' }],
    pagination: { page: 1, pageCount: 1, pageSize: 10, totalCount: 4 }
  },
  ...
  docSearchResult: { message: 'documents retrieved successfully',
    documents:
    [{ id: 1,
